...
<?php 
// extras added march 24th 2016 //
//***3 day forecast for home weather simplicity template***//	  
$json = file_get_contents('http://api.wunderground.com/api/'.$api.'/forecast/q/pws:'.$id.'.json');
$data = json_encode($json);
$file = '../jsondata/forecast.json';
